...
It contains three different options of building your locations. The full code is available [here](https://github.com/slovnicki/beamer/tree/master/examples/location_builders).
