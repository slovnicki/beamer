  ...
  List<BeamPage> pagesBuilder(BuildContext context) => [
        BeamPage(
          child: Scaffold(
              body: ElevatedButton(
            child: Text('login'),
            onPressed: () => LoginState.of(context).isLoggedIn = true,
          )),
        ),
      ];
}
...
class LoginState extends InheritedWidget {
  LoginState({Widget child}) : super(child: child);

  bool isLoggedIn = true;

  static LoginState of(BuildContext context) =>
      context.dependOnInheritedWidgetOfExactType<LoginState>();
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool isLoggedIn =
        context.dependOnInheritedWidgetOfExactType<LoginState>().isLoggedIn;
    return MaterialApp.router(
      ...
      routerDelegate: RootRouterDelegate(
        ...
        //   )
        // ],
        beamLocations: [LoginLocation(), RootLocation()],
