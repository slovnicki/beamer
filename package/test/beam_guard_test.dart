  ...
  group('shouldGuard', () {
    test('is true if the location has a blueprint matching the guard', () {
      final guard = BeamGuard(
        ...
        check: (_, __) => true,
        beamTo: (context, currentLocation) => Location2(const RouteInformation()),
      );
        ...
        final router = BeamerDelegate(
          ...
          guards: [
            BeamGuard(
              ...
              beamTo: (context, currentLocation) =>
        ...
        final router = BeamerDelegate(
          ...
          guards: [
            BeamGuard(
              pathPatterns: ['/l2'],
              check: (context, loc) => false,
              beamToNamed: (currentLocation) => '/l1',
            ),
          ],
        );
      ...
      final delegate = BeamerDelegate(
        ...
        guards: [
          ...
          BeamGuard(
            pathPatterns: ['/2'],
            check: (_, __) => false,
            beamToNamed:(currentLocation) => '/3',
          ),
          BeamGuard(
            pathPatterns: ['/3'],
            check: (_, __) => false,
            beamToNamed:(currentLocation) => '/1',
          ),
        ],
      );
